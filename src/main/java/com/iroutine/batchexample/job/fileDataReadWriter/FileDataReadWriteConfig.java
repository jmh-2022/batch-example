package com.iroutine.batchexample.job.fileDataReadWriter;

import com.iroutine.batchexample.job.fileDataReadWriter.dto.Player;
import com.iroutine.batchexample.job.fileDataReadWriter.dto.PlayerYears;
...
//                })
    ...
    @StepScope
    @Bean
    public FlatFileItemWriter<PlayerYears> playerItemWrite2(){
        BeanWrapperFieldExtractor<PlayerYears> fieldExtractor = new BeanWrapperFieldExtractor<>();
        ...
        FileSystemResource outputResource = new FileSystemResource("players_output2.txt");

        return new FlatFileItemWriterBuilder<PlayerYears>()
                .name("playerItemWrite2")
                .resource(outputResource)
                .lineAggregator(lineAggregator)
                .build();
    }
